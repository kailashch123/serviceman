	         ...
	         <div class="row">
	            <div class="form-group col-md-12">
	            	<table style="font-family: Calibri;font-size:13px;">
	            		<tr>
	            			<td>
	            			 	<label for="delDate" class="datePickerWidth">Delivery Date</label>
				                <div class="col-md-7">
				                    <form:input type="text" path="delDate" id="datepicker" class="form-control input-sm" style="width:100px;" />
				                </div>
	            			</td>
	            			<td>
	            				<label for="delTime" class="datePickerWidth">Delivery Time</label>
	               				<div class="col-md-7">
	                    			<form:select path="delTime" style="width:75px;">
						    			<form:options items="${delTimes}" />
									</form:select>
	                			</div>
	            			</td>
	            		</tr>
